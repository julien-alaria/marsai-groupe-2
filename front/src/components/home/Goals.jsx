  ...
  return (
    <div className="pt-12 pb-12 w-full">
      ...
      <h2 className="text-6xl font-bold text-center text-white uppercase pb-6">
        {t("pages.home.goals.title")} <span className="text-[#F6339A]">{t("pages.home.goals.titleAccent")}</span>
      </h2>
      ...
      <div className="pt-12 pb-12 pl-12 pr-12 w-full
        ...
        <ThreeCards
          icon={<svg height="200" width="200" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M11 12a1 1 0 1 0 2 0a1 1 0 1 0-2 0"/><path d="M7 12a5 5 0 1 0 10 0a5 5 0 1 0-10 0"/><path d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0-18 0"/></g></svg>}
          title={t("pages.home.goals.card1.title")}
          description={t("pages.home.goals.card1.description")}
          accentColor="#00D492"
        ...
        <ThreeCards
          icon={<svg height="200" width="200" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M13 10V3L5 14h6v7l8-11h-6Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
          </svg>}
          title={t("pages.home.goals.card2.title")}
          description={t("pages.home.goals.card2.description")}
          accentColor="#00B8DB"
          borderColor="border-[rgba(0,184,219,0.40)]"
          hoverShadow="hover:shadow-[0_0_40px_rgba(0,184,219,0.7)]"
        />
        ...
        <ThreeCards
          ...
          title={t("pages.home.goals.card3.title")}
          description={t("pages.home.goals.card3.description")}
          accentColor="#C27AFF"
