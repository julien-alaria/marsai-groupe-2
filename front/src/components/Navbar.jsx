...
useEffect(() => { 
  ...
  return (
    ...
    <div className={`flex mt-0 ml-2.5 mr-2.5 bg-black/30 text-white text-xl uppercase rounded-full justify-between items-center p-1 border-white/30 border-2 fixed top-8 left-0 right-0 z-50 transition-all duration-300
      ...
      {/* Desktop navigation */}
      <div className="hidden sm:flex gap-6 items-center font-bold">
        {navLinks.map((link) => (
          <Link key={link.to} to={link.to} className="mr-4 hover:text-[#F6339A]">
            {link.icon}
          </Link>
        ))}
      </div>
      ...
      <div className="hidden sm:flex items-center gap-2">
        ...
        <button
          ...
          title="Français"
          style={{ opacity: i18n.language === 'fr' ? 1 : 0.5, cursor: 'pointer', transition: 'opacity 0.3s', background: 'none', border: 'none' }}
        >
          <svg height="25" width="25" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            <mask id="circleFlagsFr0"><circle cx="256" cy="256" fill="#fff" r="256"/></mask>
        ...
        <button
          ...
          title="English"
          style={{ opacity: i18n.language === 'en' ? 1 : 0.5, cursor: 'pointer', transition: 'opacity 0.3s', background: 'none', border: 'none' }}
        >
          <svg height="25" width="25" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            <mask id="circleFlagsEn0"><circle cx="256" cy="256" fill="#fff" r="256"/></mask>
        ...
        <div className="mr-3">
          {firstName ? (
            ...
            <Link to="/auth/login">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8 hover:opacity-80 transition-opacity">
      ...
      <button
        className="sm:hidden mr-3 text-white focus:outline-none"
    ...
    {isMobileMenuOpen && (
      <div className="sm:hidden fixed top-24 left-2.5 right-2.5 z-50 bg-black/95 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl p-4">
        <nav className="flex flex-col gap-1 mb-4">
          {navLinks.map((link) => (
            <Link
              key={link.to}
              to={link.to}
              className="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-white/10 hover:text-[#F6339A] transition-colors"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              {link.icon}
              <span className="text-base font-semibold uppercase tracking-wide">{link.label}</span>
            </Link>
          ))}
        </nav>

        <div className="border-t border-white/10 pt-3 flex items-center justify-between px-2">
          {/* Language switchers */}
          <div className="flex gap-3">
            ...
            >
              <svg height="25" width="25" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <mask id="circleFlagsFr1"><circle cx="256" cy="256" fill="#fff" r="256"/></mask>
                <g mask="url(#circleFlagsFr1)">
                  <path d="M167 0h178l25.9 252.3L345 512H167l-29.8-253.4z" fill="#eee"/>
                  <path d="M0 0h167v512H0z" fill="#0052b4"/>
                  <path d="M345 0h167v512H345z" fill="#d80027"/>
                </g>
            ...
            >
              <svg height="25" width="25" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <mask id="circleFlagsEn1"><circle cx="256" cy="256" fill="#fff" r="256"/></mask>
                <g mask="url(#circleFlagsEn1)">
                  <path d="m0 0l8 22l-8 23v23l32 54l-32 54v32l32 48l-32 48v32l32 54l-32 54v68l22-8l23 8h23l54-32l54 32h32l48-32l48 32h32l54-32l54 32h68l-8-22l8-23v-23l-32-54l32-54v-32l-32-48l32-48v-32l-32-54l32-54V0l-22 8l-23-8h-23l-54 32l-54-32h-32l-48 32l-48-32h-32l-54 32L68 0z" fill="#eee"/>
                  <path d="M336 0v108L444 0Zm176 68L404 176h108zM0 176h108L0 68ZM68 0l108 108V0Zm108 512V404L68 512ZM0 444l108-108H0Zm512-108H404l108 108Zm-68 176L336 404v108z" fill="#0052b4"/>
                  <path d="M0 0v45l131 131h45zm208 0v208H0v96h208v208h96V304h208v-96H304V0zm259 0L336 131v45L512 0zM176 336L0 512h45l131-131zm160 0l176 176v-45L381 336z" fill="#d80027"/>
                </g>
          ...
          <div className="text-sm">
            {firstName ? (
              <div className="flex items-center gap-3">
                <span>Hello, {firstName}{lastName && ` ${lastName}`}</span>
                <button onClick={handleLogout} className="text-[#F6339A] font-semibold">Logout</button>
              </div>
            ) : (
              <Link to="/auth/login" onClick={() => setIsMobileMenuOpen(false)}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-7 h-7 hover:opacity-80 transition-opacity">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                </svg>
              </Link>
            )}
