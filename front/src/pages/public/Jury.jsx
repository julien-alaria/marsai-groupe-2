    ...
    <>
      ...
      <section className="flex flex-col lg:flex-row justify-center items-center mt-6 md:mt-8 mb-8 gap-6 px-4 md:px-8">
        <div className="flex justify-center">
          <img
            className="h-64 sm:h-72 md:h-80 lg:h-85 rounded-xl grayscale-30"
      ...
      <div className="flex justify-center items-center mt-5 px-6">
        <p className="text-center">{t("pages.juryPublic.membersSubtitle")}</p>
      </div>

      <section className="text-[#2B7FFF] px-4 sm:px-10 md:px-20 lg:px-70">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
          <div className="bg-[url(../src/assets/images/jury/tina-baz-le-gal_monteuse.jpg)] h-64 sm:h-72 md:h-80 lg:h-80 w-64 sm:w-72 md:w-80 lg:w-80 bg-cover justify-center hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="mt-65 font-bold text-xl text-center text-[#2B7FFF]">{t("pages.juryPublic.members.tina.name")}</h2>
            <p className="text-white text-center">{t("pages.juryPublic.members.tina.role")}</p>
          </div>

          <div className="bg-[url(../src/assets/images/jury/jerome-genevray-réalisateur_et_scenariste.jpg)] h-64 sm:h-72 md:h-80 lg:h-80 w-64 sm:w-72 md:w-80 lg:w-80 bg-cover justify-center hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="mt-65 font-bold text-xl text-center text-[#2B7FFF]">{t("pages.juryPublic.members.jerome.name")}</h2>
            <p className="text-white text-center">{t("pages.juryPublic.members.jerome.role")}</p>
          </div>

          <div className="bg-[url(../src/assets/images/jury/eve-machuel_productrice.jpeg)] h-64 sm:h-72 md:h-80 lg:h-80 w-64 sm:w-72 md:w-80 lg:w-80 bg-cover justify-center hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="mt-65 font-bold text-xl text-center text-[#2B7FFF]">{t("pages.juryPublic.members.eve.name")}</h2>
            <p className="text-white text-center">{t("pages.juryPublic.members.eve.role")}</p>
          </div>
        </div>
      </section>

      <section className="text-[#2B7FFF] px-4 sm:px-10 md:px-20 lg:px-70 py-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
          <div className="bg-[url(../src/assets/images/jury/anne-sophie-novel_journaliste_auteure_réalisatrice.jpeg)] h-64 sm:h-72 md:h-80 lg:h-80 w-64 sm:w-72 md:w-80 lg:w-80 bg-cover justify-center hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="mt-65 font-bold text-xl text-center text-[#2B7FFF]">{t("pages.juryPublic.members.anne.name")}</h2>
            <p className="text-white text-center">{t("pages.juryPublic.members.anne.role")}</p>
          </div>

          <div className="bg-[url(../src/assets/images/jury/vipulan-puvaneswaran_militant_écologiste.jpg)] h-64 sm:h-72 md:h-80 lg:h-80 w-64 sm:w-72 md:w-80 lg:w-80 bg-cover justify-center hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="mt-65 font-bold text-xl text-center text-[#2B7FFF]">{t("pages.juryPublic.members.vipulan.name")}</h2>
            <p className="text-white text-center">{t("pages.juryPublic.members.vipulan.role")}</p>
          </div>

          <div className="bg-[url(../src/assets/images/jury/Barbara-schulz_comédienne.jpg)] h-64 sm:h-72 md:h-80 lg:h-80 w-64 sm:w-72 md:w-80 lg:w-80 bg-cover justify-center hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="mt-65 font-bold text-xl text-center text-[#2B7FFF]">{t("pages.juryPublic.members.barbara.name")}</h2>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 justify-items-center pt-10 md:pt-20 pb-10 md:pb-20 px-4">
        ...
        <div className="bg-[#0d0d0d] flex flex-col justify-center items-center pt-4 pb-4 pr-6 pl-6 border-2 border-[#ad46ff]/20 rounded-4xl h-60 w-90 hover:shadow-[0_0_20px_rgba(173,70,255,0.5)] transition-shadow duration-200">
          <svg className="bg-[#252525] rounded-full p-1 border-[#ad46ff]/50 border-2 hover:shadow-[0_0_20px_rgba(173,70,255,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24">
            <path d="M7 4.5a3 3 0 0 0-2.567 4.554a3.001 3.001 0 0 0 0 5.893M7 4.5a2.5 2.5 0 0 1 5 0v15a2.5 2.5 0 0 1-5 0a3 3 0 0 1-2.567-4.553M7 4.5c0 .818.393 1.544 1 2m-3.567 8.447A3 3 0 0 1 6 13.67" fill="none" stroke="#AD46FF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
          </svg>
        ...
        <div className="bg-[#0d0d0d] flex flex-col justify-center items-center pt-4 pb-4 border-2 border-[#00D492]/20 rounded-4xl h-60 w-90 hover:shadow-[0_0_20px_rgba(0,212,146,0.5)] transition-shadow duration-200">
          <svg className="bg-[#252525] rounded-full p-1 border-[#00D492]/50 border-2 hover:shadow-[0_0_20px_rgba(0,212,146,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24">
          ...
          <p className="text-white flex justify-center items-center">{t("pages.juryPublic.criteria.aesthetic.description")}</p>
        </div>
        ...
        <div className="bg-[#0d0d0d] flex flex-col justify-center items-center pt-4 pb-4 pr-8 pl-8 border-2 border-[#F6339A]/20 rounded-4xl h-60 w-90 hover:shadow-[0_0_20px_rgba(246,51,154,0.5)] transition-shadow duration-200">
          <svg className="bg-[#252525] rounded-full p-1 border-[#F6339A]/50 border-2 hover:shadow-[0_0_20px_rgba(246,51,154,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 512 512">
        ...
        <div className="bg-[#0d0d0d] flex flex-col justify-center items-center pt-4 pb-4 pr-8 pl-8 border-2 border-[#00B8DB]/20 rounded-4xl h-60 w-90 hover:shadow-[0_0_20px_rgba(0,184,219,0.5)] transition-shadow duration-200">
          <svg className="bg-[#252525] rounded-full p-1.5 border-[#00B8DB]/50 border-2 hover:shadow-[0_0_20px_rgba(0,184,219,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24">
          ...
          <p className="text-white flex justify-center items-center">{t("pages.juryPublic.criteria.emotion.description")}</p>
        </div>
