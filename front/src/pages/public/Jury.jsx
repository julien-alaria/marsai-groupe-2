...
export default function JuryPublic() {
  return (
      <>
        ...
        <h1 className="text-3xl md:text-5xl font-bold">Président</h1>
      </div>
      ...
      <section className="flex flex-col lg:flex-row justify-center items-center mt-8 mb-8 gap-8 px-4 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="bg-[#101828] border-[#364153] border-2 rounded-xl h-auto lg:h-85 w-full lg:w-120 m-5 pr-8 pl-8 pb-4 pt-4 text-center flex flex-col justify-center items-center">
          ...
          <p className="text-white text-center flex flex-col justify-center items-center pb-4 pt-4 text-sm md:text-base">
            Pierre Schoeller est diplômé de l’Ecole Louis Lumière. Après des années de travail comme scénariste, il réaliste sa première fiction pour Arte Zero Défaut. Puis un premier long métrage Versailles, avec Guillaume Depardieu et Judith Chemla. Suit L’Exercice de l’État avec Olivier Gourmet et Michel Blanc. Les Anonymes fiction Canal Plus. Il consacre de longues années à un film sur la Révolution française Un Peuple et son Roi. Son prochain film pour le cinéma sera Rembrandt.
          </p>
        </div>
      </section>
...
<div className="flex flex-col md:flex-row justify-center items-center pt-10 pb-8 text-center">
        <h1 className="text-3xl md:text-5xl font-bold">Membres du</h1>
    ...
    <p className="mb-8">Experts IA, cinéastes et visionnaires réunis pour délibérer sur la sélection officielle.</p>
    </div>
   ...
   {/* GRID JURY */}
      ...
      <section className="text-[#2B7FFF]  px-4 sm:px-8 lg:px-16 xl:px-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pr-10 pl-10">
          ...
          <div className="bg-[url(../src/assets/images/jury/tina-baz-le-gal_monteuse.jpg)] relative w-full aspect-square bg-cover bg-center flex flex-col justify-end items-center p-4 hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="font-bold text-xl text-center">TINA BAZ LE GAL</h2>
          ...
          <div className="bg-[url(../src/assets/images/jury/jerome-genevray-réalisateur_et_scenariste.jpg)] relative w-full aspect-square bg-cover bg-center flex flex-col justify-end items-center p-4 hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="font-bold text-xl text-center">JEROME GENEVRAY</h2>
          ...
          <div className="bg-[url(../src/assets/images/jury/eve-machuel_productrice.jpeg)] relative w-full aspect-square bg-cover bg-center flex flex-col justify-end items-center p-4 hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="font-bold text-xl text-center">EVE MACHUEL</h2>
          ...
          <div className="bg-[url(../src/assets/images/jury/anne-sophie-novel_journaliste_auteure_réalisatrice.jpeg)] relative w-full aspect-square bg-cover bg-center flex flex-col justify-end items-center p-4 hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="font-bold text-xl text-center">ANNE SOPHIE NOVEL</h2>
          ...
          <div className="bg-[url(../src/assets/images/jury/vipulan-puvaneswaran_militant_écologiste.jpg)] relative w-full aspect-square bg-cover bg-center flex flex-col justify-end items-center p-4 hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="font-bold text-xl text-center">VIPULAN PUVANESSWARAN</h2>
          ...
          <div className="bg-[url(../src/assets/images/jury/Barbara-schulz_comédienne.jpg)] relative w-full aspect-square bg-cover bg-center flex flex-col justify-end items-center p-4 hover:shadow-[0_0_20px_rgba(2,183,255,0.8)] transition-shadow duration-200">
            <h2 className="font-bold text-xl text-center">BARBARA SCHULZ</h2>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center pt-20 md:pt-30 font-bold text-3xl md:text-5xl uppercase text-center">
        <h2>La charte</h2>
        <h2 className="md:ml-4 text-[#F6339A]">De notation</h2>
      </div>
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 justify-items-center pt-20 md:pt-30 pb-20 md:pb-30 px-4"> 
            ...
            <svg className=" bg-[#252525] rounded-full p-1 border-[#00D492]/50 border-2 hover:shadow-[0_0_20px_rgba(0,212,146,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path d="M21.92 11.6C19.9 6.91 16.1 4 12 4s-7.9 2.91-9.92 7.6a1 1 0 0 0 0 .8C4.1 17.09 7.9 20 12 20s7.9-2.91 9.92-7.6a1 1 0 0 0 0-.8ZM12 18c-3.17 0-6.17-2.29-7.9-6C5.83 8.29 8.83 6 12 6s6.17 2.29 7.9 6c-1.73 3.71-4.73 6-7.9 6Zm0-10a4 4 0 1 0 4 4a4 4 0 0 0-4-4Zm0 6a2 2 0 1 1 2-2a2 2 0 0 1-2 2Z" fill="#00D492"/> </svg> 
            <h2 className="text-[#00D492] uppercase font-bold text-2xl mt-3 mb-3"> Esthétique visuelle </h2> 
            <p className="text-white flex justify-center items-center">La cohérence et la beauté du <br/> rendu global.</p> 
            </div> 
            ...
            <svg className=" bg-[#252525] rounded-full p-1.5 border-[#00B8DB]/50 border-2 hover:shadow-[0_0_20px_rgba(0,184,219,0.8)] transition-shadow duration-200" height="55" width="55" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path d="M12 1.316C6.099 1.316 1.316 6.099 1.316 12S6.099 22.684 12 22.684S22.684 17.901 22.684 12c-.012-5.896-4.788-10.672-10.683-10.684H12zm0 22.297C5.586 23.613.387 18.414.387 12S5.586.387 12 .387S23.613 5.586 23.613 12v.015c0 6.405-5.192 11.597-11.597 11.597H12h.001z" fill="#00B8DB"/> <path d="M12 24C5.373 24 0 18.627 0 12S5.373 0 12 0s12 5.373 12 12c-.034 6.614-5.386 11.966-11.997 12zM12 .774C5.8.774.774 5.8.774 12S5.8 23.226 12 23.226S23.226 18.2 23.226 12C23.222 5.802 18.198.779 12.001.774zm0 22.374C5.886 23.148.929 18.191.929 12.077S5.886 1.006 12 1.006s11.071 4.957 11.071 11.071S18.114 23.148 12 23.148zm0-21.445C6.313 1.703 1.703 6.313 1.703 12S6.313 22.297 12 22.297S22.297 17.687 22.297 12v-.005c0-5.684-4.608-10.292-10.292-10.292H12z" fill="#00B8DB"/> <path d="M18.116 14.245v.036a6.08 6.08 0 0 1-6.08 6.08h-.038H12h-.036a6.08 6.08 0 0 1-6.08-6.08v-.038v.002zM9.677 9.91v.009c0 1.15-.932 2.082-2.082 2.082h-.009a2.09 2.09 0 1 1 2.09-2.09zm8.904 0a2.09 2.09 0 0 1-4.18 0v-.009c0-1.15.932-2.082 2.082-2.082h.009a2.132 2.132 0 0 1 2.09 2.088v.002z" fill="#00B8DB"/> </svg> 
            <h2 className="text-[#00B8DB] uppercase font-bold text-2xl mt-3 mb-3"> émotion & impact </h2> 
            <p className="text-white flex justify-center items-center"> La capacité du film à <br/>toucher le spectateur.</p> 
            </div> 
